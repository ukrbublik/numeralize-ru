...
UK.UNITS = {
    ...
    'долар США': [
        ['долар США', 'долара США', 'долару США', 'долар США', 'доларом США', 'доларі США'],
        ['долари США', 'доларів США', 'доларам США', 'долари США', 'доларами США', 'доларах США'],
    ],
    'цент': [
...
UK.TENS = [
  ...
  "дев'яноста",
    ...
    ["п'ят", 'шіст', 'сім', 'вісім'].map(function(p) {
        return [
            p+'десят',
            [p+'десятьох', p+'десяти'],
            [p+'десятьом', p+'десяти'],
